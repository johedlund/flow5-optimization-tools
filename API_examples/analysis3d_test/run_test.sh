...
build_dir="${root_dir}/API_examples/analysis3d_test/build"
...
cmake -S "${root_dir}/API_examples/analysis3d_test" -B "${build_dir}" "${cmake_args[@]}"
cmake --build "${build_dir}"
OPENBLAS_NUM_THREADS=1 LD_LIBRARY_PATH="${lib_xfoil}:${lib_fl5}:${LD_LIBRARY_PATH:-}" "${build_dir}/Analysis3dTest"
