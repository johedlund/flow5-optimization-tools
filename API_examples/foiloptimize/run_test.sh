...
build_dir="${root_dir}/API_examples/foiloptimize/build"
...
cmake -S "${root_dir}/API_examples/foiloptimize" -B "${build_dir}" "${cmake_args[@]}"
cmake --build "${build_dir}"
OPENBLAS_NUM_THREADS=1 "${build_dir}/FoilOptimizeRun"
